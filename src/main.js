...
document.addEventListener("DOMContentLoaded", () => {
	...
	*/
	...
	/**
	 * OPTIMIZED Parallax dust system
	 * --------------------
	 * Changes from original:
	 * - Runs at 30fps instead of 60fps (saves ~50% CPU)
	 * - Pauses during active scrolling (saves more CPU)
	 * - Auto-resumes 300ms after scroll stops
	 *
	 * REMOVED FOR NOW. Too expensive for the result.
	 *
	 */
	...
	//   const TARGET_FPS = 30; // Changed from 60
	...
	//     state.lastTime = time - (elapsed % FRAME_TIME);
	...
	//     }, 300); // Resume 300ms after scroll stops
	//   };
